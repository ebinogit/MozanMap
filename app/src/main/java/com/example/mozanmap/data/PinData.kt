...
object PimData {
    val pinItem = listOf(
        ...
        PinItem(23,"講義実験棟",823f,83f),

        PinItem(16,"プール",33f,83f),
        PinItem(17,"体育館", -50f,-137f),
        PinItem(18,"図書館棟",1490f,530f),
        PinItem(19,"片柳記念ホール",1160f,-195f),
        PinItem(20,"テニスコート",-327f,47f),
        PinItem(21,"弓道場",390f,-250f),
        PinItem(22,"総合グラウンド",183f,517f),

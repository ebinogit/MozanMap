...
object PimData {
    val pinItem = listOf(
        ...
        PinItem(16,"片柳記念ホール",1160f,-195f),
        PinItem(17,"体育館", -50f,-137f),
        PinItem(18,"テニスコート",-327f,47f),
        PinItem(19,"プール",33f,83f),
        PinItem(20,"弓道場",390f,-250f),
        PinItem(21,"総合グラウンド",183f,517f),
        PinItem(22,"講義実験棟",823f,83f),
        PinItem(23,"土木・造園実習場",2285f,-325f),
        PinItem(24,"守衛棟(西門)",2285f,380f),
        PinItem(25,"守衛棟(正門)",1920f,1440f),

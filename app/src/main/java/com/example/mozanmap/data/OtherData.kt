        ...
        OtherItem(2,"図書館",R.drawable.library2, listOf(
            ...
            OtherItem2("2F",R.drawable.tosho_2f, listOf(
                ...
                OtherItem3(-1,"学務課学生係","学生生活全般をサポートしています。主な取扱い事項は次のとおりです。\n"+"・奨学金に関すること\n"+"日本育英会をはじめ、各種奨学金の手続きや相談にお応えします。\n"+"・学生会館に関すること\n"+"学生会館（八王子みなみ野駅前）の入寮管理、手続きを行っています。\n"+"・課外活動に関すること\n"+"課外活動費事務、体育施設利用申込受付（学生）等を行っています。\n"+"・外国人留学生のサポート等\n"+"留学生の学生生活をバックアップしています。\n"+"・学生保険／事故対応\n"+"学生保険手続き、急病や怪我、事故の緊急応対を行っています。\n"+"・アルバイトの斡旋\n"+"Webを中心にアルバイトの紹介を行っています。\n"+"・遺失物／拾得物の管理\n"+"落し物の管理、保管をしています。学外から届いた物も保管しています。\n"+"この他にも幅広く相談にのりますので、気軽に学務課 学生係へ。","","", listOf(
                    R.drawable.gakumu1,
                    R.drawable.gakumu2)),
                OtherItem3(-1,"学務課大学院係","大学院学生に関する事務のほか、大学院の入試関連事務を取扱っています。主な取扱い事項は次のとおりです。\n" +"・履修手続、授業、成績管理に関すること\n" +"・学費に関すること\n" +"・各種証明書の発行（在学、修了見込、成績等）\n" +"・住所、氏名等の変更受付\n" + "・休学、復学、退学等に関すること\n" + "・修士及び博士の学位授与に関すること\n" +"・入試に関すること","","", listOf(
                    R.drawable.gakumu3,
                    R.drawable.gakumu4)))),
            OtherItem2("3F",R.drawable.no, listOf(
                OtherItem3(-1,"IKEAラウンジ","3階には、快適性とデザイン性を備えたインテリアを展開する世界的ブランド、IKEAの製品を使用したコミュニケーション空間を整備しています（2022年リニューアル）。\n" + "サステイナブルな環境に配慮してIKEA立川によりコーディネートされたこの空間には、「Discussing Together, Learning Together（共に語り、共に学ぶ）」をスローガンにした学生の交流や学修をサポートする４つのエリアが用意されています。\n" + "●グループワークスペース：各種ミーティングや発表などに対応。\n" + "●ディスカッションエリア：ソファーとテーブル席で一緒に学修するエリア\n" + "●リラクシングエリア：読書や休憩に最適な落ち着いたスペース。\n" + "●アクティブラーニングエリア：モニターが常設されたファミレスタイプの席で共に学ぶエリア","","", listOf(
                    R.drawable.ikea1,
                    R.drawable.ikea2,
                    R.drawable.ikea3,
                    R.drawable.ikea4)),
                OtherItem3(-1,"メディアセンター／プリントショップ","3階のプリントショップでは、講義や実験等で使用するレポート等をプリントアウトすることができます。","","", listOf(
                    R.drawable.print)))),
            OtherItem2("4F",R.drawable.no, listOf(
                OtherItem3(-1,"メディアセンター／図書館","4階には、学生及び教職員に学術研究上必要な資料を収集・管理し、また閲覧および貸出しを行なっております。\n" + "利用できる資料には、図書（和書・洋書・電子ブック）、雑誌、電子ジャーナル・データベース（ScienceDirect、Scopus、EBSCO Discovery Service、日経ＢＰ記事検索サービス、eol企業ナビ、日経テレコン21）等があります。","","", listOf(
                    R.drawable.tosyo1,
                    R.drawable.tosyo2)))))),
